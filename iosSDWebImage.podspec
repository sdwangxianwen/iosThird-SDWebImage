...
s.homepage = 'https://github.com/sdwangxianwen/iosThird-SDWebImage.git'
s.author = { 'Olivier Poitrey' => '870183756@qq.com' }
s.source = { :git => 'https://github.com/sdwangxianwen/iosThird-SDWebImage.git', :tag => s.version.to_s }
